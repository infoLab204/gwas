# check if package "seqinr" has been installed
if(!require(seqinr)) install.packages("seqinr")
library(seqinr)

# generating simulated data:
# parameters
# q: minor allele frequency,  pi: rate of variation,  snp: number of SNPs, 
# n: sample size, rho: shuffling rate
# (eg) q=0.25, pi=0.05, snp=20000, n=300, rho=0.5
